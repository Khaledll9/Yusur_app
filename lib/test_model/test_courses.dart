...
final List<Course> allCourses = const [
  ...
  Course(
    ...
    description:
        'دورة متقدمة في برنامج Adobe Illustrator المتخصص في الرسم والتصميم المتجهي (Vector Graphics). تركز الدورة على إنشاء الرسومات التوضيحية، الشعارات، الأيقونات، التصاميم المطبعية Typography، والرسومات القابلة للتوسع دون فقدان الجودة. تشمل التقنيات المتقدمة: استخدام أدارة Pen Tool باحترافية، إنشاء الأنماط والفرش، العمل مع الشبكات المتكررة، تصميم الإنفوجرافيك، وإعداد الملفات للطباعة والويب. مثالية لمصممي الجرافيك، مصممي الشعارات، والفنانين الرقميين.',
    photoPath: AppImages.assetsImagesTestImage,
    nameAr: '',
  ),
  Course(
