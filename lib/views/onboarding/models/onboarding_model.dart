class OnboardingModel {
  ...
  static List<OnboardingModel> data = [
    OnboardingModel(
      ...
      contentImage: "assets/images/app_icon.png",
      text: "مرحباً بك في تطبيق يسر\nتطبيق للإعلان ومعرفة دبلومات ودورات المعاهد",
    ),
    OnboardingModel(
    ...
    OnboardingModel(
      ...
      text: "يتيح للطلاب مشاهدة إعلانات الدبلومات والدورات المتاحة في المعاهد وحجز مقاعد فيها",
    ),
  ];
}
